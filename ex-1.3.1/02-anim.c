...
int main(int argc, char* args[])
{
    ...
    while (1) {
        ...
        // quadrado vermelho, se movimentando nessa ordem: direita, baixo, esquerda, cima. 
       ...
       // quadrado verde, se movimentando nessa ordem: baixo, esquerda, cima, direita.
      ...
      // quadrado azul, se movimentando nessa ordem: esquerda, cima, direita, baixo.
     ...
     // quadrado amarelo, se movimentando nessa ordem: cima, direita, baixo, esquerda
