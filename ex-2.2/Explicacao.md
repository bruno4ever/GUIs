...
- Caso o evento recebido seja soltar o botão do mousem, se o estado atual for PRESSIONADO, apenas muda o estado para PARADO. Se o estado atual for ARRASTANDO, é salva a posição atual do quadrado como a nova posição original, e o estado muda para PARADO.
